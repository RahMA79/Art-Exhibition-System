...
def onTap():
    ...
    import categoryArts
# Create the buttons
btn1 = CTK.CTkButton(Categories, text='Abstrct arts', image=photo1, font=("Arial", 12, 'bold'), command=onTap, fg_color=btnColor,bg_color=btnColor, compound='top',hover_color=hovColor)
btn2 = CTK.CTkButton(Categories, text='Expressionism arts', image=photo2, font=("Arial", 12, 'bold'), command=onTap, fg_color=btnColor,bg_color=btnColor,compound='top', hover_color=hovColor)
btn3 = CTK.CTkButton(Categories, text='Figuratve arts', image=photo3, font=("Arial", 12, 'bold'), command=onTap, fg_color=btnColor,bg_color=btnColor,compound='top',hover_color=hovColor)
btn4 = CTK.CTkButton(Categories, text='Sculpture arts', image=photo4, font=("Arial", 12, 'bold'), command=onTap, fg_color=btnColor,bg_color=btnColor,compound='top',hover_color=hovColor)
btn5 = CTK.CTkButton(Categories, text='Painting arts', image=photo5, font=("Arial", 12, 'bold'), command=onTap, fg_color=btnColor,bg_color=btnColor,compound='top', hover_color=hovColor)
btn6 = CTK.CTkButton(Categories, text='Visual arts', image=photo6, font=("Arial", 12, 'bold'), command=onTap, fg_color=btnColor,bg_color=btnColor,compound='top', hover_color=hovColor)
