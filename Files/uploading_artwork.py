...
def uploadImage():
    ...
    if file_path:
        ...
        img_label = CTK.CTkLabel(img_frame,image=img_tk,text="",width=450,height=200)
...
def postButton():
    try:
       ...
       cur.execute("INSERT INTO ArtWork (title,Category,description,Date_of_creation,Img_URL)VALUES(?,?,?,?,?)",(title,category,caption,date,file_path))
       con.commit()
