...
def screenStyle():
    ...
    categoryArts.geometry("1100x600")
...
def navigationBar():
    ...
    nav_frame.artist_img_tk = artist_img_tk
    ...
    icons_frame.categoryIcon_tk = categoryIcon_tk
    ...
    icons_frame.postIcon_tk = postIcon_tk
    ...
    logout_btn.grid()
    icons_frame.logoutIcon_tk = logoutIcon_tk
...
def update_arts():
    ...
    for art in art_data:
        ...
        try:
            ...
            artFrame.img_tk = img_tk  # Keep a reference to prevent garbage collection
        ...
        def selected():
            ...
            categoryArts.destroy()
            import artWorkDisc
            artWorkDisc.artDiscription(art_id)

        artBtn = CTK.CTkButton(artFrame, width=200, height=200, text="", image=img_tk, fg_color=primaryColor, hover_color=hovColor, command=selected)
